...
wram_female_speed_ggplot %>%
  ggplot(aes(x = Day, y = avr_speed, group = Treatment, linetype = Treatment, shape = Treatment)) + geom_point(size = 3) + geom_line(size = 1, alpha = 0.8) + theme_bw() + ylab("Average speed (m/s)") + ggtitle("Figure 3. Average speed find platform over day\nby females") + theme (plot.title = element_text(size = 16, face = "bold")) + geom_smooth(method = "lm", se = FALSE, colour = "black")
...
wram_male_speed_ggplot %>%
  ggplot(aes(x = Day, y = avr_speed, group = Treatment, linetype = Treatment, shape = Treatment)) + geom_point(size = 3) + geom_line(size = 1, alpha = 0.8) + theme_bw() + ylab("Average speed (m/s)") + ggtitle("Figure 6. Average speed find platform over day\nby males") + theme (plot.title = element_text(size = 16, face = "bold")) + geom_smooth(method = "lm", se = FALSE, colour = "black")
#Figure 16 - graph for sex difference in speed in SALINE treated animals
